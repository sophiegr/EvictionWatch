<script>
    ...
    onMount(async () => {
      ...
      map.addSource("corporate_ownership", {
        type: "geojson",
        data: "src/public/data/CorpOwner.geojson",
      });
      map.addSource("owner_occupancy", {
        type: "geojson",
        data: "src/public/data/OwnerOccupancy.geojson",
      });
  ...
  <div class="context">
    <h2>Context</h2>
      <figure>
        <img src="src/public/image/Graph_4.png" alt="" />
      </figure>
      <p>Since 2004, corporate ownership rates in Boston have skyrocketed. In every single neighborhood, there was at least a 10% increase in corporate ownership rate. 
        ...
        <figure>
          <img src="src/public/image/Graph_5.png" alt="" />
        </figure>
        ...
        <figure>
          <img src="src/public/image/Graph_6.png" alt="" />
        </figure>
